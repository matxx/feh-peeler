<template>
  <div>
    <div class="position-relative">
      <v-btn
        v-tooltip="t('seals.filters.resetFilters')"
        flat
        position="absolute"
        location="top end"
        icon="mdi-restart"
        size="x-small"
        @click="storeSealsFilters.resetFilters"
      />
    </div>
...
import type { IFilters } from '~/utils/types/seals-filters'
import type { ISorters } from '~/utils/types/seals-sorters'
