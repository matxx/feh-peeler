...
export default {
  ...
  skillsOwners: {
    ...
    order: {
      ...
      [availability.U_AV_SCORE_GENERIC_POOL_3_4]: '3★ / 4★',
      [availability.U_AV_SCORE_GENERIC_POOL_45]: '4★ SR',
      [availability.U_AV_SCORE_GENERIC_POOL_5]: '5★',
      // [availability.U_AV_SCORE_HEROIC_GRAILS]: 'Heroic Grails',
      [availability.U_AV_SCORE_HEROIC_GRAILS_4]: 'Heroic Grails (4★)',
      [availability.U_AV_SCORE_HEROIC_GRAILS_5]: 'Heroic Grails (5★)',
      // [availability.U_AV_SCORE_LIMITED_DIVINE_CODES]: 'Limited Divine Codes',
      // [availability.U_AV_SCORE_NORMAL_DIVINE_CODES]: 'Divine Codes',
      [availability.U_AV_SCORE_SPECIAL_POOL_4]: '4★ SH',
      [availability.U_AV_SCORE_SPECIAL_POOL_45]: '4★ SHSR',
      [availability.U_AV_SCORE_SPECIAL_POOL_5]: '5★ SH',
      [availability.U_AV_SCORE_LIMITED_HEROES]: '5★ Limited Heroes',
  ...
  unitsFodder: {
    ...
    availabilities: {
      ...
      [obfuscatedKeys.AV_HEROIC_GRAILS_4]: 'Heroic Grails (4★)',
      [obfuscatedKeys.AV_HEROIC_GRAILS_5]: 'Heroic Grails (5★)',
  ...
  skills: {
    index: {
      ...
      headers: {
        ...
        [skillsColumns.COLUMN_MIGHT]: 'Might',
        [skillsColumns.COLUMN_RANGE]: 'Range',
